...
最近看到好多人关注这个 Repo。有问题，欢迎关注公众号（**公众号的微信号是: jikerizhi**。），给我留言私信。
...
[cols="2*^",frame=none]
|===
| image:book/images/alipay.png[title="支付宝", alt="支付宝", width="90%"] | image:book/images/wxpay.png[title="微信", alt="微信", width="90%"]
|===

有些打赏的朋友希望可以加个好友，欢迎关注D瓜哥的微信公众号，这样就可以通过公众号的回复直接给我发信息。

image:book/images/wx-jikerizhi.png[align="center",width=98%]
